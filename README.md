...
- **[lattice-music](https://github.com/VirInvictus/lattice-music)** · CLI/TUI audit and visualization suite for music collections: ~25 read-only modes, with the cleaning/apestrip write brains folded into the package behind explicit opt-in modes. the filesystem is the source of truth; writes are dry-run by default and gated behind `--clean`/`--apestrip` plus `--apply`. `Python · mutagen · vir-tui` · *complete v5.5.0*
...
- **[deadbeef-cui](https://github.com/VirInvictus/deadbeef-cui)** · faceted, foobar2000-columns library browser plugin for the DeaDBeeF player. `C` · *complete v1.3.6*
