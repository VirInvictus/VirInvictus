...
- **[CalibreQuarry](https://github.com/VirInvictus/CalibreQuarry)** · CLI/TUI front-end for `cquarry`. goes beyond wrapper scripts by implementing deep data mining: extracting literal copyright-page text from book binaries to verify database ISBNs against reality. `Python · vir-tui` · *shipping v3.49.0*
